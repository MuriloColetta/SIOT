...
def control(led_num, action):
    ...
    # Você pode ver essa mensagem no console do desenvolvedor do navegador (F12).
...
if __name__ == '__main__':
    ...
    # port=5008: Define a porta em que o servidor irá rodar.

    print("Servidor de teste iniciado!")
    print("Abra seu navegador e acesse: http://localhost:5008")
